...
class poloniex:
    ...
    def api_query(self, command, req={}):
        ...
        try:
            if(command == "returnTicker" or command == "return24Volume"):
                ...
                req['command'] = command
                req['nonce'] = int(time.time()*1000 + 100000000000)
    ...
    # Outputs:
    # response      {"BTC_DASH":{"BTC":"8.50274777","DASH":"654.05752077"},...
    #"BTC_LTC":{"BTC":"8.50274777","LTC":"1214.67825290"},"BTC_XMR":{"BTC":"8.50274777","XMR":"3696.84685650"}}
